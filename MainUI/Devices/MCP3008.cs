...

{
    public class MCP3008
    {
        ...
        public async Task Initialize()
        {
            ...
            try
            {
                ...
                if (mcp3008 == null)
                {
                    ...
                    Debug.WriteLine("SPI Initialized Successfully");
        ...
        public int ReadADC(byte whichChannel)
        {
            ...
            var commandBuf = new byte[3] { 0x01, command, 0x00 };

            var readBuf = new byte[3] { 0x00, 0x00, 0x00 };

            mcp3008.TransferFullDuplex(commandBuf, readBuf);

            var sample = readBuf[2] + ((readBuf[1] & 0x03) << 8);
            //int s2 = sample & 0x3FF;
